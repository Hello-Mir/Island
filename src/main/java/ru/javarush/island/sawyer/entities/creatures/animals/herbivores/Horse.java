...
@CreatureData(name = "horse", icon = "\uD83D\uDC0E", weight = 0, speed = 0, totalFoodMass = 0, maxToSpawn = 0)
public class Horse extends Herbivore{
    public Horse(String name, String icon, Double weight, int speed, Double totalFoodMass, int maxToSpawn) {
