...
@CreatureData(name = "wolf", icon = "\uD83D\uDC3A", weight = 0, speed = 0, totalFoodMass = 0, maxToSpawn = 0)
public class Wolf extends Predator {

    public Wolf(String name, String icon, Double weight, int speed, Double totalFoodMass, int maxToSpawn) {
