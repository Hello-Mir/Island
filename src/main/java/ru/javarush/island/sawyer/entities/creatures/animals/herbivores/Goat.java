...
@CreatureData(name = "goat", icon = "\uD83D\uDC10", weight = 0, speed = 0, totalFoodWeight = 0, maxToSpawn = 0)
public class Goat extends Herbivore{

    public Goat(String name, String icon, Double weight, int speed, Double totalFoodWeight, int maxToSpawn) {
